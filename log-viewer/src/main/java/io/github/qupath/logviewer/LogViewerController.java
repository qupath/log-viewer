 ...
 */
public class LogViewerController extends BorderPane {
    ...
    private final Collection<String> allLogLevelNamesToLowerCase = Arrays.stream(Level.values()).map(LogViewerController::toStyleClass).toList();
     ...
     */
    public LogViewerController() throws IOException {
    ...
    private void setUpTable() {
        ...
        colRow.setCellValueFactory(LogViewerController::cellValueFactory);
        colLevel.setCellValueFactory(LogViewerController::cellValueFactory);
        colThread.setCellValueFactory(LogViewerController::cellValueFactory);
        colLogger.setCellValueFactory(LogViewerController::cellValueFactory);
        colTimestamp.setCellValueFactory(LogViewerController::cellValueFactory);
        colMessage.setCellValueFactory(LogViewerController::cellValueFactory);
